...
import sys, traceback, json, logging, os, html
from wickerdevs.config import secrets

logging.basicConfig(
    format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', level=logging.INFO)
botlogger = logging.getLogger("telegram.bot")
...
def error(update, context):
    ...
    botlogger.error(msg="Exception while handling an update:", exc_info=context.error)
